Public Class ToolBar
    ...
    Private Sub ToolBar_MouseDown(sender As Object, e As MouseEventArgs) Handles MyBase.MouseDown
        _mParentPosition = New Point(Cursor.Position.X - Location.X, Cursor.Position.Y - Location.Y)
        _mMouseAction = True
    End Sub

    Private Sub ToolBar_MouseMove(sender As Object, e As MouseEventArgs) Handles MyBase.MouseMove
    ...
    Private Sub ToolBar_MouseUp(sender As Object, e As MouseEventArgs) Handles MyBase.MouseUp
        _mMouseAction = False
    End Sub
End Class
